...
function Recruitment() {
    ...
    const handleUpload = () => {
        ...
        //axios.post('https://nedifoods-api.vercel.app/sendinfo', formdata)
        axios.post('http://localhost:4000/sendinfo', formdata)
        .then(res => {
    ...
    useEffect(() => {
        //axios.get('https://nedifoods-api.vercel.app/getitems')
    ...
    const handleDelete = (delID) => {
      ...
      //axios.delete(`https://nedifoods-api.vercel.app/deleteitems/${delID}`)
      axios.delete(`http://localhost:4000/deleteitems/${delID}`)
      .then(res =>{
